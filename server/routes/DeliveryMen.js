...
// # get all 
router.get('/', isLoggedIn ,asyncErrorHandler(deliveryManController.getAllDeliveryMan));
// # get by id
router.get('/:id', isLoggedIn , verifyRole(["DeliveryMan" , "Restaurant"]) ,asyncErrorHandler(deliveryManController.getDeliveryManById));
// # update location
