...
import { Phone, Mail, Star, Clock, MapPin } from "lucide-react"
...
import { getRestaurantByResId } from "@/Redux/Slices/restaurantSlice";
...
const RestaurantDetails = () => {
  ...
  useEffect(() => {
    if (!restaurantData) {
      ...
      dispatch(getRestaurantByResId(resId));
    }
    console.log("restaurantData", restaurantData);
  }, [dispatch, restaurantData, resId]);
        ...
        {!restaurantData ? (
          ...
          <section className="mb-12">
            <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <div>
                <h1 className="text-3xl font-bold mb-2">{restaurantData?.restaurantName}</h1>
                <p className="text-muted-foreground mb-4">{restaurantData?.quickDescription}</p>
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span>
                    Open: {restaurantData?.openingHours} - {restaurantData?.closingHours}
                  </span>
                </div>
                <div className="flex flex-col gap-2 mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>{restaurantData?.email || "Email Not Set"}</span>
                  </div>
                </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">{restaurantData?.detailedDescription}</p>
            </div>
          </section>
