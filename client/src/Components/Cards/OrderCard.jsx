        ...
        >
            ...
            <div className="flex flex-col items-center gap-1">
                <p className="font-semibold relative">
                    Order Status:
                    {(role === "Customer" || role == "DeliveryMan") &&
                        newStatus}
                    {role === "Restaurant" && (
                        <select
                            value={newStatus}
                            ...
                            className="border flex p-2 rounded ml-2 appearance-none focus:outline-none focus:border-blue-500 bg-gray-100 hover:bg-gray-200 transition-colors duration-300"
                        >
            ...
            <div className="mb-4">
                <div className="flex items-between">
                    <div>
                        <button
                            className="text-red-400 text-semibold p-1"
